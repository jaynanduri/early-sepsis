...
if __name__ == "__main__":
    ...
    pickle_file_path = 'D:\IE7374_MLOps\Project_Datasets\Practice\Files\Training_set_A/sepsis_df_zero_imput_train_test.pkl'

    with open(pickle_file_path, 'rb') as file:
        loaded_data = pickle.load(file)

    # Access the loaded arrays using the keys
    X_train = loaded_data['X_train_zero_imputed']
    y_train = loaded_data['y_train_zero_imputed']
    X_test = loaded_data['X_test_zero_imputed']
    y_test = loaded_data['y_test_zero_imputed']
